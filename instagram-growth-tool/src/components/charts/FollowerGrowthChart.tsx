    ...
    <HoverableCard className="transition-all duration-300">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        ...
        >
          <div className="flex items-center justify-between mb-3">
            ...
            <IconWrapper
              ...
              size="sm"
              animated={hoveredCard === 'total-growth'}
        ...
        <HoverableCard 
          ...
          onHover={(isHovered) => setHoveredCard(isHovered ? 'avg-growth' : null)}
        >
          <div className="flex items-center justify-between mb-3">
            ...
            <IconWrapper
              ...
              color="secondary"
              size="sm"
              animated={hoveredCard === 'avg-growth'}
              pulse
            />
          </div>
          <p className="text-2xl font-bold text-gray-900 dark:text-white mb-1">
        ...
        <HoverableCard 
          ...
          onHover={(isHovered) => setHoveredCard(isHovered ? 'current-followers' : null)}
        >
          <div className="flex items-center justify-between mb-3">
            ...
            <IconWrapper
              ...
              color="success"
              size="sm"
              animated={hoveredCard === 'current-followers'}
              glow
            />
          </div>
          <p className="text-2xl font-bold text-gray-900 dark:text-white mb-1">
